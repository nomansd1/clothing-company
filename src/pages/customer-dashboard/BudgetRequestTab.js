...
function BudgetRequestTab() {
  const [tableData, setTableData] = useState([
    { id: 1, name: 'Syed Noman Ali', budget: 100, allocate: 240, action: true },
    { id: 2, name: 'Syed Hasnain Askari', budget: 500, allocate: 10, action: false },
    { id: 3, name: 'Subhan Akram', budget: 1100, allocate: 5240, action: false },
    { id: 4, name: 'Zaroon Ali', budget: 5050, allocate: 6730, action: true },
  ])
