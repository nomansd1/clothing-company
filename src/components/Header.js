        ...
        <div className='fixed top-0 left-0 w-full flex items-center justify-between bg-black text-white py-3 px-5'>
            ...
            <div className='relative'>
                <div className='relative flex items-center cursor-pointer'>
                    <button onClick={() => setDropdown(!dropdown)} className='flex items-center'>
                    ...
                    (<div className="absolute top-8 right-0 z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow mt-2.5 transition-all duration-500 ease-out">
                        <ul className="py-1 px-1 text-sm">
                            <li
                                className="flex items-center px-4 py-2 rounded-md hover:bg-[#F3F4F6]">
                                <a className="flex items-center justify-between" href="#">
                                    ...
                                    <div className="flex flex-col ml-2">
                                        <span className="text-xs font-semibold text-black">Noman Ali</span>
                                        <span className="text-xs text-[#9B9B9B]">noman.sd114@gmail.com</span>
                                    </div>
                                </a>
                            </li>
                            <li
                                ...
                                <a href="#" className="text-sm flex items-center w-full">
                                    <span className="material-symbols-rounded !text-md">logout</span>
