        ...
        <>
            {(props.state || props.modalState) && (
                ...
                <div className="bg-white rounded-lg p-6 max-w-md flex flex-col items-center transition-all duration-500 ease-in-out w-[40%]">
                    {props.type === "success" && (
                        <span class="material-symbols-rounded text-green-500 text-[5rem] rounded-full">
                            task_alt
                        </span>
                    )}
                    {props.type === "warning" && (
                        <span class="material-symbols-rounded text-red-500 text-[5rem] rounded-full">
                            warning
                        </span>
                    )}
                    {props.type === "confirm" && (
                        <span class="material-symbols-rounded text-yellow-500 text-[5rem] rounded-full">
                            help
                        </span>
                    )}
